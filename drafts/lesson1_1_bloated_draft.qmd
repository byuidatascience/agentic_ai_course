...
|----------|--------|--------|----------|---------------|-------------|
| [🏃‍♂️‍➡️](../practice/practice1_1.ipynb) | [🌱](../preps/prep1_1.html) | [🧑‍🏫](../lecture_slides/slide1_1.html) | [📓]({{< var notebook_base >}}1_1.ipynb "Opens in Google Colab - See README if broken") | [📋](../instructor_notes/notes1_1.html) | [➡️](lesson1_2.html) |
...
|----------|--------|-------------|
| [🏃‍♂️‍➡️](../practice/practice1_1.ipynb) | [🌱](../preps/prep1_2.html) | [➡️](lesson1_2.html) |
...
relevant potential challenges working with API's, Why you need to hide your API key

System Prompts
Configure model (temp, token limit, system prompt)
---

# Preparation

Before this lesson, read the prep:

| Resource | Description |
|----------|-------------|
| [🌱 Prep 1.1](../preps/prep1_1.html) | What is an API? Read this before class. |
...
### What is an API? (Reiterate from prep)
...
3. Read the prep for Lesson 1.2 before you arrive
