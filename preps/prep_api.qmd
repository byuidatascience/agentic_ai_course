...
1. An API is a backend connection to an online service.
2. An API key is the password (also termed a "secret")
3. We will access big LLM providers via API (ie Gemini, GPT)
...
Optional short video diving into API's:

{{< video https://www.youtube.com/watch?v=ByGJQzlzxQg >}}
...
This prep is just to get the concept in your head before we build with it. Everything will make more sense once you see it live in class.
:::
